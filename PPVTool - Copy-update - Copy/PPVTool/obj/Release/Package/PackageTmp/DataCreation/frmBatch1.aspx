<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmBatch1.aspx.cs" Inherits="PPVTool.DataCreation.frmBatch1" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <table style="width: 50%;" class="table">
                    <tr>
                        <th style="text-align: center;" colspan="2">SELECTION OF TEST RATE TEST
                            <asp:Label ID="lblMsg" runat="server" Visible="false"></asp:Label>
                        </th>
                    </tr>
                    <tr>
                        <td style="width: 30%;">Select UP-release :
