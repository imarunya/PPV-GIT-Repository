...
{
    public partial class testAnalysys : System.Web.UI.Page
    {
       //CultureInfo myCIintl = new CultureInfo("sv-SE", false);
        protected void Page_Load(object sender, EventArgs e)
        {
           
            int wcdrnr;
            int wstyr, p_up_lpnr, p_db2_lpnr;
            String uprls, hfMskn, miljo, imsSystem;
            ...
            if (!Page.IsPostBack)
            {
                ...
                GridView1.DataSource = dc.TestAnalysisGenerate(wcdrnr, wstyr);
                GridView1.DataBind();
        ...
        //protected void btnanalysisreport_Click(object sender, EventArgs e)
        //{
        ...
        //    Response.AppendHeader("Contetnt-disposition", "attachement;filename= testAnalysys.pdf");
